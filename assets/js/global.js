...
class PortfolioGlobal {
    ...
    // WhatsApp Floater with Fallback
    initWhatsAppFloater() {
    ...
    async handleWhatsAppClick() {
        ...
        try {
            ...
            if (isMobile) {
                ...
                // Try web WhatsApp for desktop
                const whatsappWindow = window.open(webWhatsappUrl, '_blank');
                
                // If window doesn't open or gets blocked, show fallback
                setTimeout(() => {
